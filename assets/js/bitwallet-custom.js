...
jQuery(document).ready(function($){
    ...
    /*--- 5. Skin list ---*/
    /*---------------------------------------------*/
    jQuery(".skin").on('click', function(){
        jQuery(".skin-list").css("display", "block");
    });
    jQuery(".skin-list i.icon-close").on('click', function(){
        jQuery(".skin-list").css("display", "none");
    });
    ...
    /*---------------------------------------------*/
    /*- 8. Pie Chart - Define data for each year --*/
    /*---------------------------------------------*/
